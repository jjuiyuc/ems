...
var (
	aiDatumAllColumns            = []string{"id", "gw_uuid", "log_date", "customer_id", "local_ai_data", "created_at", "updated_at"}
	aiDatumColumnsWithoutDefault = []string{"gw_uuid", "log_date", "customer_id", "local_ai_data", "updated_at"}
